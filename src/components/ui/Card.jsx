...
function Card({ product, onQuickUpdate, onDelete }) {
  ...
  return (
    <div className="shadow-sm rounded-xl overflow-hidden bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 hover:shadow-lg">
      ...
      <div className="card-footer px-5 mb-5 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
        <div className="grid grid-cols-2 sm:flex gap-2 w-full sm:w-auto">
          <button
            ...
            className="flex items-center justify-center gap-2 py-2 px-3 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-600 hover:border-gray-300 dark:hover:border-gray-500 text-sm rounded text-gray-500 dark:text-gray-300 cursor-pointer"
          >
        ...
        <div className="grid grid-cols-2 sm:flex gap-2 w-full sm:w-auto">
          ...
          <button
            ...
            disabled={loading}
            className={`flex items-center justify-center gap-2 py-2 px-3 rounded text-sm
    ${loading
                ? "bg-gray-200 dark:bg-slate-700 text-gray-400 dark:text-gray-500 cursor-not-allowed"
                : "bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/20 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-500/20 cursor-pointer"
              }
  `}
          >
            {loading ? (
