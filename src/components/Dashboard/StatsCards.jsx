...
<div
  className={`group relative bg-white p-7 rounded-xl shadow-xl border-t-4 ring-1 dark:ring-slate-700 ring-gray-200 ${borderColor}
  transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl dark:bg-slate-900 `}
>
<div
...
const cards = [
  {
    ...
    bgColor: "bg-cyan-500 dark:bg-cyan-500",
    iconColor: "text-cyan-900 dark:text-cyan-900",
  },
  {
  ...
  },
  {
    ...
    iconColor: "text-purple-900 dark:text-purple-900",
  },
  {
    title: "Users",
    ...
    iconColor: "text-pink-900 dark:text-pink-900",
  },
  {
    title: "Top Product",
